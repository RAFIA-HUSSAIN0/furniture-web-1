        ...
        <>
            ...
            <div className="bg-white">
                ...
                <div className="text-center py-8 ">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-4 gap-8 mt-6 px-8">
                        {/* Product Card 1 */}
                        <div className=" p-4 rounded-lg">
                            <Image src="/images/Simple.png" alt="Simple" width={400} height={300} className="w-full h-auto" />
                            <p className="font-medium mt-2 text-gray-600">Trenton modular sofa</p>
                            <h3 className="font-medium text-black font-poppins text-2xl leading-[36px]">Rs. 25,000.00</h3>
                        </div>
                        {/* Product Card 2 */}
                        <div className="p-4 rounded-lg">
                            <Image src="/images/Chairs.png" alt="Chairs" width={400} height={300} className="w-full h-auto" />
                            <p className="font-medium mt-2 hover:text-blue-500 text-gray-600">Granite dining table</p>
                            <p className="font-medium text-black font-poppins text-2xl leading-[36px]">Rs. 25,000.00</p>
                        </div>
                        {/* Product Card 3 */}
                        <div className="p-4 rounded-lg">
                            <Image src="/images/Sample.png" alt="Sample" width={400} height={300} className="w-full h-auto" />
                            <p className="font-medium mt-2 text-gray-600">Outdoor bar table</p>
                            <p className="font-medium text-black font-poppins text-2xl leading-[36px]">Rs. 25,000.00</p>
                        </div>
                        {/* Product Card 4 */}
                        <div className=" p-4 rounded-lg">
                            <Image src="/images/Mez.png" alt="Mez" width={400} height={300} className="w-full h-auto" />
                            <p className="font-medium mt-2 text-gray-600">Plain console</p>
                            <p className="font-medium text-black font-poppins text-2xl leading-[36px]">Rs. 25,000.00</p>
                        </div>
                    </div>
                ...
                <div className="bg-[#FFF9E5] mt-[80px] py-8">
                    <div className="flex flex-col sm:flex-row items-center justify-center px-8">
                        <div>
                            <Image src="/images/Bed.png" alt="Asgaard Sofa" width={983} height={799} />
